    ...
    <div class="container" id="container">
        <div class="form-container sign-up">
            <form>
                ...
                <input type="text" placeholder="Nome" required nome="nome">
                <input type="text" placeholder="Sobrenome" required nome="sobrenome">
                <input type="email" placeholder="E-mail" required nome="email">
                <input type="password" placeholder="Senha" required nome="senha">
